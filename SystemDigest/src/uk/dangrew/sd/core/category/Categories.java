...
public class Categories {
   ...
   /**
    * {@link Category} of {@link uk.dangrew.sd.core.message.Message} used when an error is detected.
   ...
   /**
    * {@link Category} of {@link uk.dangrew.sd.core.message.Message} used for showing general information.
    * @return the {@link Category}.
    */
   ...
   /**
    * {@link Category} of {@link uk.dangrew.sd.core.message.Message} used for showing state changes and the status of something.
    * @return the {@link Category}.
    */
   ...
   /**
    * {@link Category} of {@link uk.dangrew.sd.core.message.Message} used for when objects are created.
    * @return the {@link Category}.
    */
   ...
   /**
    * {@link Category} of {@link uk.dangrew.sd.core.message.Message} used for when an iterative process is
    * being performed.
    * @return the {@link Category}.
    */
